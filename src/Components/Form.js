    ...
    return(
        <form className="border mt-3 mb-3 px-7 py-3 rounded-md justify-center space-y-5 items-center" id="form" onSubmit={onSubmit}>
            ...
            <div className="flex flex-col space-y-2">
                ...
                <input className=" border border-black rounded-md px-2" type="text" name="title" id="title" placeholder="Titulo" />
            </div>
            <div className="flex flex-col space-y-2">
                <label htmlFor="description" >Descripcion: </label>
                <input className="border border-black rounded-md px-2" type="text" name="description" id="description" placeholder="Descripcion" />
            </div>
            <div className="flex flex-col space-y-2">
